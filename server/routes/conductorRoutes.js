...
import conductorSchema from "../models/tenant/Conductor.js";
...
router.post("/", async (req, res) => {
    try {
        const Conductor = getTenantModel(req.tenantConnection, 'Conductor', conductorSchema);
...
router.get("/export", async (req, res) => {
    try {
        ...
        res.download(filePath, "conductors.xlsx", () => {
